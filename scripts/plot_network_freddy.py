...
if __name__ == "__main__":
    ...
    map_boundaries = [4.9, 15.51, 46.59, 55.24]
    
    input_network = '/home/freddy/Dokumente/pypsa-eur_50/networks/elec_today_s.nc'
    
    n = load_network_for_plots(input_network, snakemake.input.tech_costs, snakemake.config)
    
    #auswertung
    
    buses_de = n.buses[n.buses.country == 'DE'].index
    
    lines_de = n.lines.query('bus0 in @buses_de and bus1 in @buses_de')
    links_de = n.links.query('bus0 in @buses_de and bus1 in @buses_de')
